  ...
  return (
    <div className="os-container">
      ...
      <form className="os-form" onSubmit={handleSubmit}>
        ...
        <input name="nome" value={form.nome} onChange={handleChange} placeholder="Nome da O.S." required />
        <input name="numero" value={form.numero} onChange={handleChange} placeholder="Número da O.S." required />
        ...
        <input name="tipo_produto" value={form.tipo_produto} onChange={handleChange} placeholder="Tipo do Produto" />

        <textarea name="defeito" value={form.defeito} onChange={handleChange} placeholder="Defeito informado" />
        <textarea name="complemento" value={form.complemento} onChange={handleChange} placeholder="Complemento" />
        <textarea name="descricao" value={form.descricao} onChange={handleChange} placeholder="Descrição do Serviço" required />

        <input type="number" step="0.01" name="valor" value={form.valor} onChange={handleChange} placeholder="Valor (R$)" />
